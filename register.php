        ...
        *********************************************************************************************************************************************************** -->
        ...
        <div id="login-page">
            <div class="container  jumbotron">
                ...
                <form class="form-login" action="php/register_process.php" method="post" enctype="multipart/form-data">
                  <h2 class="form-login-heading">REGISTER NOW</h2>
                  <div class="login-wrap">
                      <input type="text" class="form-control" name="firstname" required placeholder="First Name" autofocus>
                      ...
                      <button class="btn btn-theme btn-block" type="submit"><i class="fa fa-pencil"></i> REGISTER</button>
                      <hr>
                      ...
                      <div class="registration">
                          ...
                          <a class="" href="php/register_process.php">
                              Create an account
                          </a>
                      </div>
